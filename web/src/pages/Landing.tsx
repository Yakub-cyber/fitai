...
const STEPS = [
  ...
  {
    n: '02',
    title: 'Алгоритм строит план',
    text: 'Подбираем тренировку и меню под ваши данные, инвентарь и цель — мгновенно.',
  },
  {
    n: '03',
...
const FEATURES = [
  {
    ...
    text: 'Программа собирается под ваш уровень, цели и инвентарь — от новичка до продвинутого, с разминкой, техникой и отдыхом.',
  },
  {
    icon: '🥗',
    title: 'План питания',
...
const STATS = [
  { value: 'мгновенно', label: 'генерация плана' },
  { value: '100%', label: 'персонально под вас' },
  { value: '0 ₽', label: 'без абонемента' },
  { value: 'офлайн', label: 'работает в браузере' },
]
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Нет. Можно указать «без инвентаря» — алгоритм составит программу с собственным весом для дома.',
  },
  {
    q: 'Насколько персональны планы?',
    a: 'Учитываются уровень, цель, возраст, вес, рост и доступные продукты — план собирается под ваши параметры.',
  },
  {
    q: 'Мои данные в безопасности?',
    a: 'Профиль, тренировки и дневник хранятся локально в вашем браузере и не отправляются на сервер. Ничего третьим лицам мы не передаём.',
  },
]
    ...
    <div className="landing">
      ...
      <section className="hero">
        <div className="hero-inner landing-container">
          <div className="hero-content">
            <span className="badge">✨ Работает офлайн — данные остаются у вас</span>
            <h1>
              Персональный <span className="accent">AI-тренер</span>
              <br />и диетолог в кармане
            </h1>
            <p className="hero-sub">
              Соберём тренировку и план питания под ваши цели, уровень и продукты — мгновенно.
              Без абонемента, без записи, бесплатно.
            </p>
            ...
            <p className="hero-trust">Бесплатно · Без карты · Готовый план за секунду</p>
          </div>
      ...
      <section className="section landing-container">
        <div className="section-head">
          ...
          <p className="section-sub">Тренировки, питание и прогресс — в одном приложении</p>
        </div>
        ...
        <div className="pricing-card">
          <div className="pricing-info">
            ...
            <p className="section-sub">
              ...
              статистика. Никаких платежей и подписок — просто тренируйтесь.
            </p>
            <ul className="pricing-list">
              <li>Безлимитная генерация тренировок</li>
              <li>Персональные планы питания по вашим продуктам</li>
